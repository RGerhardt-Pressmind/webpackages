...
<head>
	...
	<?php
	echo \package\core\template::getStyles('header', true);
	?>
	<script>
...
<body data-spy="scroll" data-target="#navbar" data-offset="0">
	<div style="position: fixed; top: 0; right: 0; padding: 5px; background-color: #155273; z-index: 99999;">
		<a href="<?php echo HTTP.'index.php?c=welcome&m=change_language&lng=de_DE'; ?>">
			<img src="<?php echo \package\core\template::getImageUrl('flags/Germany.png'); ?>" title="Deutsch" alt="Deutsch" width="24" height="24">
		</a>
		<a href="<?php echo HTTP.'index.php?c=welcome&m=change_language&lng=en_US'; ?>">
			<img src="<?php echo \package\core\template::getImageUrl('flags/United-States.png'); ?>" title="English" alt="English" width="24" height="24">
		</a>
		<a href="<?php echo HTTP.'index.php?c=welcome&m=change_language&lng=fr_FR'; ?>">
			<img src="<?php echo \package\core\template::getImageUrl('flags/France.png'); ?>" title="Français" alt="Français" width="24" height="24">
		</a>
		<a href="<?php echo HTTP.'index.php?c=welcome&m=change_language&lng=it_IT'; ?>">
			<img src="<?php echo \package\core\template::getImageUrl('flags/Italy.png'); ?>" title="Italiano" alt="Italiano" width="24" height="24">
		</a>
	</div>
