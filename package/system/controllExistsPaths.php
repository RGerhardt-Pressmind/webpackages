...
$controllPaths	=	array(PACKAGE_DIR, SYSTEM_PATH, TEMPLATE_DIR, CORE_DIR, EXCEPTION_DIR, CACHE_PATH, LANGUAGE_PATH, DYNAMIC_DIR, PAGE_DIR, PLUGIN_DIR, IMPLEMENT_DIR, LIB_DIR);
