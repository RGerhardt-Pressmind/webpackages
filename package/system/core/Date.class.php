...
class Date extends initiator implements IStatic
{
	...
	public static $timezone = array(
		...
		array(
			'zone' => 'Arctic',
			'cities' => array('Arctic/Longyearbyen' => 'Longyearbyen')
		),
		array(
			'zone' => 'Asia',
			'cities' => array(
	...
	public static function _get_nation_holidays_by_year($year, $nation = self::NATION_GERMANY)
	{
		...
		if($nation === self::NATION_GERMANY)
		{
			...
			$holidays = array(
				$year.'-01-01' => array('name' => 'Neujahr'),
				$year.'-01-05' => array('name' => 'Tag der Arbeit'),
				$year.'-01-06' => array(
				...
				$gruendonnerstag => array('name' => 'Gründonnerstag'),
				$karfreitag => array('name' => 'Karfreitag'),
				$ostersonntag => array('name' => 'Ostersonntag'),
				$ostermontag => array('name' => 'Ostermontag'),
				$chirstiHimmelfahrt => array('name' => 'Christi Himmelfahrt'),
				$pfingstsamstag => array('name' => 'Pfingstsamstag'),
				$pfingstsonntag => array('name' => 'Pfingstsonntag'),
				$pfingstmontag => array('name' => 'Pfingstmontag'),
				$fronleichname => array(
					'name' => 'Fronleichnam',
					'federal_state' => array(
						self::STATE_BW,
				...
				$year.'-12-25' => array('name' => '1. Weihnachtstag'),
				$year.'-12-26' => array('name' => '2. Weihnachtstag')
			);
		}
		elseif($nation === self::NATION_AUSTRIAN)
		{
			$holidays = array(
				$year.'-01-01' => array('name' => 'Neujahr'),
				$year.'-01-06' => array('name' => 'Heilige Drei Könige'),
				$year.'-11-01' => array('name' => 'Allerheiligen'),
				$year.'-08-15' => array('name' => 'Mariä Himmelfahrt'),
				$year.'-05-01' => array('name' => 'Staatsfeiertag'),
				$year.'-10-26' => array('name' => 'Nationalfeiertag'),
				$year.'-12-08' => array('name' => 'Mariä Empfängnis'),
				$year.'-12-25' => array('name' => 'Weihnachten'),
				$year.'-12-26' => array('name' => 'Stefanitag'),
				$allHolidays['easterSunday']->format('Y-m-d') => array('name' => 'Ostersonntag'),
				$allHolidays['easterMonday']->format('Y-m-d') => array('name' => 'Ostermontag'),
				$allHolidays['ascensionDay']->format('Y-m-d') => array('name' => 'Christi Himmelfahrt'),
				$allHolidays['pentecostMonday']->format('Y-m-d') => array('name' => 'Pfingstmontag'),
				$allHolidays['corpusChristi']->format('Y-m-d') => array('name' => 'Fronleichnam')
			);
		}
		elseif($nation === self::NATION_DENMARK)
		{
			...
			$holidays = array(
				$year.'-01-01' => array('name' => 'Nytår'),
				$year.'-12-25' => array('name' => '1. Juledag'),
				$year.'-12-26' => array('name' => '2. Juledag'),
				$allHolidays['maundyThursday']->format('Y-m-d') => array('name' => 'Skærtorsdag'),
				$allHolidays['goodFriday']->format('Y-m-d') => array('name' => 'Langfredag'),
				$allHolidays['easterSunday']->format('Y-m-d') => array('name' => 'Påskedag'),
				$allHolidays['easterMonday']->format('Y-m-d') => array('name' => '2. Påskedag'),
				$greatPrayerDay->format('Y-m-d') => array('name' => 'Store Bededag'),
				$allHolidays['ascensionDay']->format('Y-m-d') => array('name' => 'Kristi Himmelfartsdag'),
				$allHolidays['pentecostSunday']->format('Y-m-d') => array('name' => 'Pinsedag'),
				$allHolidays['pentecostMonday']->format('Y-m-d') => array('name' => '2. Pinsedag')
			);
		}
		elseif($nation === self::NATION_FRENCH)
		{
			$holidays = array(
				$year.'-01-01' => array('name' => 'Jour de l\'an'),
				$year.'-05-01' => array('name' => 'Fête du Travail'),
				$year.'-05-08' => array('name' => '8 Mai 1945'),
				$year.'-07-14' => array('name' => 'Fête Nationale'),
				$year.'-08-15' => array('name' => 'Assomption'),
				$year.'-11-01' => array('name' => 'La Toussaint'),
				$year.'-11-11' => array('name' => 'Armistice'),
				$year.'-12-25' => array('name' => 'Noël'),
				$allHolidays['easterMonday']->format('Y-m-d') => array('name' => 'Lundi de Pâques'),
				$allHolidays['ascensionDay']->format('Y-m-d') => array('name' => 'Jeudi de l\'Ascension'),
				$allHolidays['pentecostMonday']->format('Y-m-d') => array('name' => 'Lundi de Pentecôte')
			);
		}
		elseif($nation === self::NATION_ITALIAN)
		{
			$holidays = array(
				$year.'-01-01' => array('name' => 'Capodanno'),
				$year.'-01-06' => array('name' => 'Epifania'),
				$year.'-04-25' => array('name' => 'Liberazione dal nazifascismo (1945)'),
				$year.'-05-01' => array('name' => 'Festa del lavoro'),
				$year.'-06-02' => array('name' => 'Festa della Repubblica'),
				$year.'-08-15' => array('name' => 'Assunzione di Maria'),
				$year.'-11-01' => array('name' => 'Ognissanti'),
				$year.'-12-08' => array('name' => 'Immacolata Concezione'),
				$year.'-12-25' => array('name' => 'Natale di Gesù'),
				$year.'-12-26' => array('name' => 'Santo Stefano'),
				$allHolidays['easterSunday']->format('Y-m-d') => array('name' => 'Pasqua'),
				$allHolidays['easterMonday']->format('Y-m-d') => array('name' => 'Lunedì di Pasqua')
			);
		}
		elseif($nation === self::NATION_NORWEGIAN)
		{
			$holidays = array(
				$year.'-01-01' => array('name' => '1. nyttårsdag'),
				$year.'-05-01' => array('name' => '1. mai'),
				$year.'-05-17' => array('name' => 'Grunnlovsdagen'),
				$year.'-12-25' => array('name' => '1. juledag'),
				$year.'-12-26' => array('name' => '2. juledag'),
				$allHolidays['maundyThursday']->format('Y-m-d') => array('name' => 'Skjærtorsdag'),
				$allHolidays['goodFriday']->format('Y-m-d') => array('name' => 'Langfredag'),
				$allHolidays['easterSunday']->format('Y-m-d') => array('name' => '1. påskedag'),
				$allHolidays['easterMonday']->format('Y-m-d') => array('name' => '2. påskedag'),
				$allHolidays['ascensionDay']->format('Y-m-d') => array('name' => 'Kristi Himmelfartsdag'),
				$allHolidays['pentecostMonday']->format('Y-m-d') => array('name' => '2. pinsedag')
			);
		...
		{
			$holidays = array(
				$year.'-01-01' => array('name' => 'Nowy Rok'),
				$year.'-01-06' => array('name' => 'Trzech Króli'),
				$year.'-05-01' => array('name' => 'Święto Pracy'),
				$year.'-05-03' => array('name' => 'Święto Konstytucji Trzeciego Maja'),
				$year.'-08-15' => array('name' => 'Wniebowzięcie Najświętszej Maryi Panny'),
				$year.'-11-01' => array('name' => 'Wszystkich Świętych'),
				$year.'-11-11' => array('name' => 'Święto Niepodległości'),
				$year.'-12-25' => array('name' => 'Boże Narodzenie'),
				$year.'-12-26' => array('name' => 'Drugi dzień Bożego Narodzenia'),
				$allHolidays['easterSunday']->format('Y-m-d') => array('name' => 'Wielkanoc'),
				$allHolidays['easterMonday']->format('Y-m-d') => array('name' => 'Poniedziałek Wielkanocny'),
		...
		elseif($nation === self::NATION_SWEDISH)
		{
			...
			$holidays = array(
				$year.'-01-01' => array('name' => 'Nyårsdagen'),
				$year.'-01-05' => array(
					'name' => 'Trettondagsafton',
					'halfday' => true
				),
				$year.'-01-06' => array('name' => 'Trettondedag jul'),
				$year.'-04-30' => array(
					'name' => 'Valborgsmässoafton',
					'halfday' => true
				),
				$year.'-05-01' => array('name' => 'Första maj'),
				$year.'-06-06' => array('name' => 'Sveriges nationaldag'),
				$year.'-12-24' => array('name' => 'Julafton'),
				$year.'-12-25' => array('name' => 'Juldagen'),
				$year.'-12-26' => array('name' => 'Annandag jul'),
				$year.'-12-31' => array('name' => 'Nyårsafton'),
				$allHolidays['maundyThursday']->format('Y-m-d') => array(
					'name' => 'Skärtorsdagen',
					'halfday' => true
				),
				$allHolidays['goodFriday']->format('Y-m-d') => array('name' => 'Långfredagen'),
				$allHolidays['easterSaturday']->format('Y-m-d') => array('name' => 'Påskafton'),
				$allHolidays['easterSunday']->format('Y-m-d') => array('name' => 'Påskdagen'),
				$allHolidays['easterMonday']->format('Y-m-d') => array('name' => 'Annandag påsk'),
				$allHolidays['ascensionDay']->format('Y-m-d') => array('name' => 'Kristi himmelsfärdsdag'),
				$allHolidays['pentecostSaturday']->format('Y-m-d') => array('name' => 'Pingstafton'),
				$allHolidays['pentecostSunday']->format('Y-m-d') => array('name' => 'Pingstdagen'),
				$midSummerDay->format('Y-m-d') => array('name' => 'Midsommardagen'),
				$midSummerDay->modify('-1 day')->format('Y-m-d') => array('name' => 'Midsommarafton'),
				$allSaintsDay->format('Y-m-d') => array('name' => 'Alla helgons dag'),
