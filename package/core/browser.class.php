...
/**
 * Auslesen von Browserdaten des Benutzers
 *
 * Mittels der Browser Klasse kann man alle wichtigen Daten eines Benutzers erfassen und verarbeiten.
 *
 * @package		Webpackages
 * @subpackage	core
 * @category	Browser
...
class browser 
{
	...
	private $_operating_system_variants	=	array(
		array(
			'regex'	=>	'Windows XP',
			'os'	=>	'Windows XP'
		),
		array(
			'regex'	=>	'Windows NT 5.1|Windows NT5.1)',
			'os'	=>	'Windows XP'
		),
		array(
			'regex'	=>	'Windows 2000',
		...
		array(
			'regex'	=>	'(media center pc).([0-9]{1,2}\.[0-9]{1,2})',
			'os'	=>	'Windows Media Center'
		),
		array(
			'regex'	=>	'(win)([0-9]{1,2}\.[0-9x]{1,2})',
			'os'	=>	'Windows'
		),
		array(
			'regex'	=>	'(win)([0-9]{2})',
		...
		array(
			'regex'	=>	'(java)([0-9]{1,2}\.[0-9]{1,2}\.[0-9]{1,2})',
			'os'	=>	'Java'
		),
		array(
			'regex'	=>	'(Solaris)([0-9]{1,2}\.[0-9x]{1,2}){0,1}',
			'os'	=>	'Solaris'
		),
		array(
			'regex'	=>	'dos x86',
		...
		array(
			'regex'	=>	'(sunos)([0-9]{1,2}\.[0-9]{1,2}){0,1}',
			'os'	=>	'SunOS'
		),
		array(
			'regex'	=>	'(beos)([0-9]{1,2}\.[0-9]{1,2}){0,1}',
			'os'	=>	'BeOS'
		),
		array(
			'regex'	=>	'(risc os)([0-9]{1,2}\.[0-9]{1,2})',
			'os'	=>	'RISC OS'
		),
		array(
			'regex'	=>	'os/2',
		...
		array(
			'regex'	=>	'(Mandriva).([0-9]{1,3}(\.[0-9]{1,3})?(\.[0-9]{1,3})?)',
			'os'	=>	'Linux - Mandriva'
		),
		array(
			'regex'	=>	'(SUSE).([0-9]{1,3}(\.[0-9]{1,3})?(\.[0-9]{1,3})?)',
			'os'	=>	'Linux - SUSE'
		),
		array(
			'regex'	=>	'(Dropline)',
			'os'	=>	'Linux - Slackware (Dropline GNOME)'
		),
		array(
			'regex'	=>	'(ASPLinux)',
			'os'	=>	'Linux - ASPLinux'
		...
		array(
			'regex'	=>	'(msproxy)/([0-9]{1,2}.[0-9]{1,2})',
			'os'	=>	'Windows'
		),
		array(
			'regex'	=>	'(msie)([0-9]{1,2}.[0-9]{1,2})',
			'os'	=>	'Windows'
		),
		array(
			'regex'	=>	'libwww-perl',
    ...
    const BROWSER_FIREFOX 			= 	'Mozilla Firefox'; // http://www.mozilla.com/en-US/firefox/firefox.html
    ...
    */
    ...
    public function __toString()
    {
        ...
        "<strong>Operating System:</strong> {$this->getOperatingSystem()}<br/>\n" .
	...
	/**
	 * Kontrolliert das Bestriebssystem
	 *
	 * @return string
	 */
	protected function checkOperatingSystem()
	{
		...
		foreach($this->_operating_system_variants as $reg)
		{
    		if(@preg_match('/'.$reg['regex'].'/i' , $this->_agent, $name))
			{
				if(isset($name[2]) === false)
				{
					$name[2]	=	'';
				}
