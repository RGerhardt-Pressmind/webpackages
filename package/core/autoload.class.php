...
class autoload
{
	 ...
	 *
	 * @throws \Exception Wird ausgegeben wenn der Klassennamen leer ist oder die Klasse nicht geladen werden konnte
	...
	public static function get($class_name, $namespace = null, $isStatic = false, $parameter = array())
    {
		...
		if(class_exists($class_name) === false)
		{
			throw new \Exception('Error: class '.$class_name.' not found');
		}
